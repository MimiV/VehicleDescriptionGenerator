...
namespace VehicleDescriptionGenerator
{
    public partial class Q7 : Form
    {
        ...
        string mmiNavigationPlusPackageOption = "";
        string ventilationPackageOption = "";
        string warmWeatherPackageOption = "";
        string driverAssistancePackageOption = "";
        string luxuryPackageOption = "";
        string adaptiveChassisPackageOption = "";
        string titaniumBlackOpticPackageOption = "";
        //################################# OPTIONS ######################################
        ...
        private void Q7Home_Click(object sender, EventArgs e)
        {
            this.Close();
        ...
        private void MMInavigationPlusPackage_CheckedChanged(object sender, EventArgs e)
        {
            if (MMInavigationPlusPackage.Checked == true)
                mmiNavigationPlusPackageOption = "*MMI Navigation Plus Package\n";
            else
                mmiNavigationPlusPackageOption = "";
        }
        private void ventilationPackage_CheckedChanged(object sender, EventArgs e)
        {
            if (ventilationPackage.Checked == true)
                ventilationPackageOption = "*Ventilation Package\n";
            else
                ventilationPackageOption = "";
        }  
        ...
        private void luxuryPackage_CheckedChanged(object sender, EventArgs e)
        {
            if (luxuryPackage.Checked == true)
                luxuryPackageOption = "*Luxury Package\n";
            else
                luxuryPackageOption = "";
        }
        private void adaptiveChassisPackage_CheckedChanged(object sender, EventArgs e)
        {
            if (adaptiveChassisPackage.Checked == true)
                adaptiveChassisPackageOption = "*Adaptive Chassis Package\n";
            else
                adaptiveChassisPackageOption = "";
        }
        private void titaniumBlackOpticPackage_CheckedChanged(object sender, EventArgs e)
        {
            if (titaniumBlackOpticPackage.Checked == true)
                titaniumBlackOpticPackageOption = "*Titanium-black Optic Package\n";
            else
                titaniumBlackOpticPackageOption = "";                 
        }
        ...
        private void checkBox4_CheckedChanged(object sender, EventArgs e)
        {
            if (checkBox4.Checked == true)
                audiCertifiedOption = "\nOn top of the original factory warranty of 48 months/50,000 Miles! " +
                    "An extra 2 years/50,000 miles limited warranty, " +
        ...
        {
            string[] opt = new string[38];           
            //############################### PACKAGES ############################
            opt[0] = coldWeatherPackageOption;
            opt[1] = mmiNavigationPlusPackageOption;
            opt[2] = ventilationPackageOption;
            opt[3] = warmWeatherPackageOption;
            opt[4] = driverAssistancePackageOption;
            opt[5] = luxuryPackageOption;
            opt[6] = adaptiveChassisPackageOption;
            opt[7] = titaniumBlackOpticPackageOption;
            //################################ OPTIONS ######################################
            opt[8] = template;
            opt[9] = equipedWithEquippedWOptions;
            opt[10] = blindSpotMonitoringOption;
            opt[11] = laneDepartureMonitoringOption;
            opt[12] = bluetoothPhoneConnectivityOption;
            opt[13] = siriusHdRadioOption;
            opt[14] = voiceControlSystemOption;
            opt[15] = navigationSystemOption;
            opt[16] = parkingAssistWBackupCameraAndParkingSensorsOption;
            opt[17] = rearviewCameraWifiOnlineServicesWAudiConnectOption;
            opt[18] = garageDoorOpenerKeylessEntryOption;
            opt[19] = collisionPreventionWAutomaticBreakingSystemOption;
            opt[20] = headUpDisplayWNavigationAndAssistanceSystemsInformationOption;
            opt[21] = audiPreSenseRearOption;
            opt[22] = hillDescentControlOption;
            opt[23] = automaticHeadlightsOption;
            opt[24] = threeZoneAutomaticClimateControlOption;
            opt[25] = heatedSeatsOption;
            opt[26] = heatedSteeringWheelOption;
            opt[27] = panoramicSunroofOption;
            opt[28] = adaptiveCruiseControlWithAutomaticStopNGoFunctionOption;
            opt[29] = audiVirtualCockpitOption;
            opt[30] = ventilatedFrontSeatsOption;
            opt[31] = sportsSeatsOption;
            opt[32] = bangNOlufsenHdPremiumSoundSystemOption;
            opt[33] = bossHdPremiumSoundSystemOption;
            opt[34] = andMuchMore;
            opt[35] = callToday;
            opt[36] = audiCertifiedOption;
            opt[37] = fiveDaysMoneyBackOption;
            if (fiveDaysMoneyBackYES.Checked == true || coldWeatherPackage.Checked == true || MMInavigationPlusPackage.Checked == true
                || driverAssistancePackage.Checked == true || ventilationPackage.Checked == true || warmWeatherPackage.Checked == true
                || luxuryPackage.Checked == true || adaptiveChassisPackage.Checked == true || titaniumBlackOpticPackage.Checked == true
                || headUpDisplayWNavigationAndAssistanceSystemsInformation.Checked == true
                ...
                || audiVirtualCockpit.Checked == true || ventilatedFrontSeats.Checked == true || checkBox4.Checked == true || checkBox1.Checked == true)
            {
                text = opt[0] + opt[1] + opt[2] + opt[3] + opt[4] + opt[5] + opt[6] + opt[7]
                  ...
                  + opt[32] + opt[33] + opt[34] + opt[35] + opt[36] + opt[37];
