...
namespace VehicleDescriptionGenerator
{
    public partial class A5 : Form
    {
       ...
       private void pictureBox1_Click(object sender, EventArgs e)
        ...
        private void A5Home_Click(object sender, EventArgs e)
        {
            this.Close();
        ...
        private void navigationPackage_CheckedChanged(object sender, EventArgs e)
        {
            if (navigationPackage.Checked == true)
                navigationPackageOption = "*Navigation Package\n";
            else
                navigationPackageOption = "";
        }
        ...
        private void designLineWheelPackage19_CheckedChanged(object sender, EventArgs e)
        {
            if (designLineWheelPackage19.Checked == true)
                designLineWheelPackageOption19 = "*19\" Design Line Wheel Package\n";
            else
                designLineWheelPackageOption19 = "";
        }
        ...
        private void goToA5Package_Click(object sender, EventArgs e)
        {
        ...
        private void done_Click(object sender, EventArgs e)
        {
            ...
            opt[1] = navigationAndTelematicsPackageOption;
            opt[2] = navigationPackageOption;
            opt[3] = sLineSportPackageOption;
            opt[4] = coldWeatherPackageOption;
            opt[5] = warmWeatherPackageOption;
            opt[6] = luxuryPackageOption;
            opt[7] = designLineWheelPackageOption19;
            ...
            if (fiveDaysMoneyBackYES.Checked == true || conveniencePackage.Checked == true || checkBox1.Checked == true || navigationPackage.Checked == true
                || SlineSportPackage.Checked == true || warmWeatherPackage.Checked == true || luxuryPackage.Checked == true
                || coldWeatherPackage.Checked == true || designLineWheelPackage19.Checked == true 
                || sportPlusPackage.Checked == true || headUpDisplayWNavigationAndAssistanceSystemsInformation.Checked == true
                ...
                || audiVirtualCockpit.Checked == true || ventilatedFrontSeats.Checked == true || checkBox2.Checked == true) { 
